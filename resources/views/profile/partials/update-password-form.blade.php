<section>
    <header>
        <h2 class="text-lg font-semibold text-brand-ink">Alterar senha</h2>
        <p class="mt-1 text-sm text-steel">Use uma senha longa e única para manter sua conta segura.</p>
    </header>
